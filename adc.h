 ...
 * Author: ashra
 *
 * Created on 01 November 2022, 16:19
 */
 ...
 */
#define ADC_ENABLE_VOLT_REFERENCE()             do{ADCON1bits.VCFG1 = 1;\
                                                     ADCON1bits.VCFG0 = 1;}\
                                                  while(0) 
#define ADC_DISABLE_VOLT_REFERENCE()            do{ADCON1bits.VCFG1 = 0;\
                                                     ADCON1bits.VCFG0 = 0;}\
                                                  while(0)
